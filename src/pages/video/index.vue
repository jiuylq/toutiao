...
import listScroll from '@/components/scroll/video/index'
import { xigualist, videoList } from '@/api/article.js'
...
export default {
  ...
  data() {
    const josnData = {}
    for (let i = 0; i < xigualist.length; i++) {
      josnData[xigualist[i].tag] = [
        {
