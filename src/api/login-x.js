webpackJsonp([5], {
    ...
    ! function (o) {
      ...
      function d(e, t) {
        ...
        for (n = 0; n < e.length; n += 16)
          ...
          a = h,
          s = m,
          d = u(d, p, h, m, e[n], 7, -680876936),
          m = u(m, d, p, h, e[n + 1], 12, -389564586),
          h = u(h, m, d, p, e[n + 2], 17, 606105819),
          p = u(p, h, m, d, e[n + 3], 22, -1044525330),
          d = u(d, p, h, m, e[n + 4], 7, -176418897),
          m = u(m, d, p, h, e[n + 5], 12, 1200080426),
          h = u(h, m, d, p, e[n + 6], 17, -1473231341),
          p = u(p, h, m, d, e[n + 7], 22, -45705983),
          d = u(d, p, h, m, e[n + 8], 7, 1770035416),
          m = u(m, d, p, h, e[n + 9], 12, -1958414417),
          h = u(h, m, d, p, e[n + 10], 17, -42063),
          p = u(p, h, m, d, e[n + 11], 22, -1990404162),
          d = u(d, p, h, m, e[n + 12], 7, 1804603682),
          m = u(m, d, p, h, e[n + 13], 12, -40341101),
          h = u(h, m, d, p, e[n + 14], 17, -1502002290),
          p = u(p, h, m, d, e[n + 15], 22, 1236535329),
          d = l(d, p, h, m, e[n + 1], 5, -165796510),
          ...
          p = l(p, h, m, d, e[n + 12], 20, -1926607734),
          d = c(d, p, h, m, e[n + 5], 4, -378558),
          m = c(m, d, p, h, e[n + 8], 11, -2022574463),
          h = c(h, m, d, p, e[n + 11], 16, 1839030562),
          p = c(p, h, m, d, e[n + 14], 23, -35309556),
          d = c(d, p, h, m, e[n + 1], 4, -1530992060),
          m = c(m, d, p, h, e[n + 4], 11, 1272893353),
          h = c(h, m, d, p, e[n + 7], 16, -155497632),
          p = c(p, h, m, d, e[n + 10], 23, -1094730640),
          d = c(d, p, h, m, e[n + 13], 4, 681279174),
          m = c(m, d, p, h, e[n], 11, -358537222),
          h = c(h, m, d, p, e[n + 3], 16, -722521979),
          p = c(p, h, m, d, e[n + 6], 23, 76029189),
          d = c(d, p, h, m, e[n + 9], 4, -640364487),
          m = c(m, d, p, h, e[n + 12], 11, -421815835),
          h = c(h, m, d, p, e[n + 15], 16, 530742520),
          p = c(p, h, m, d, e[n + 2], 23, -995338651),
          d = f(d, p, h, m, e[n], 6, -198630844),
          m = f(m, d, p, h, e[n + 7], 10, 1126891415),
          h = f(h, m, d, p, e[n + 14], 15, -1416354905),
          p = f(p, h, m, d, e[n + 5], 21, -57434055),
          d = f(d, p, h, m, e[n + 12], 6, 1700485571),
          m = f(m, d, p, h, e[n + 3], 10, -1894986606),
          h = f(h, m, d, p, e[n + 10], 15, -1051523),
          p = f(p, h, m, d, e[n + 1], 21, -2054922799),
          d = f(d, p, h, m, e[n + 8], 6, 1873313359),
          m = f(m, d, p, h, e[n + 15], 10, -30611744),
          h = f(h, m, d, p, e[n + 6], 15, -1560198380),
          p = f(p, h, m, d, e[n + 13], 21, 1309151649),
          d = f(d, p, h, m, e[n + 4], 6, -145523070),
          m = f(m, d, p, h, e[n + 11], 10, -1120210379),
          h = f(h, m, d, p, e[n + 2], 15, 718787259),
          p = f(p, h, m, d, e[n + 9], 21, -343485551),
          d = i(d, r),
          p = i(p, o),
          h = i(h, a),
          m = i(m, s);
      ...
      function x(e, t, n) {
        return t ? n ? b(t, e) : k(t, e) : n ? y(e) : w(e)
      }
      void 0 !== (r = function () {
          return x
        }
  ...
  "+YOn": function (e, t, n) {
    ...
    function a() {
      "m.ixigua.com" === location.host ? (p.default.init(),
          m.default.init()) : (f.default.init(),
          m.default.init()),
        window.maevent = o,
        window.resendMA = i
    }
    ...
    function s() {
      a(),
        (0,
          b.default)(),
        g.default.init(),
        2 === history.length && y.default.os.android && y.default.browser.weixin && location.href.indexOf("weixin_list=0") > -1 && history.back()
    }
    var u = n("dU2U"),
      l = r(u),
      c = n("yRjA"),
  ...
  "/Rgc": function (e, t, n) {
    ...
    function p(e) {
      return e ? (e ^ 16 * Math.random() >> e / 4).toString(10) : ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, p)
    }
    ...
    var E = Object.assign || function (e) {
        ...
        r(this, e),
          ...
          this.get = function () {
            for (var e = {
              ...
              }, n = t.envInfo, r = n.user, o = Object.keys(r), i = Array.isArray(o), a = 0, o = i ? o : o[Symbol.iterator]();;) {
              var s;
              if (i) {
                if (a >= o.length)
                  break;
            ...
            for (var l = n.header, c = Object.keys(l), f = Array.isArray(c), d = 0, c = f ? c : c[Symbol.iterator]();;) {
              var p;
              if (f) {
                if (d >= c.length)
                  break;
              ...
              var h = p;
              l[h] !== T && "headers" !== h && (e.header[h] = l[h])
            }
            for (var m = n.header.headers, v = Object.keys(m), g = Array.isArray(v), _ = 0, v = g ? v : v[Symbol.iterator]();;) {
              var y;
              if (g) {
                if (_ >= v.length)
                  break;
              ...
              var w = y;
              "custom" !== w && m[w] !== T && (e.header.headers[w] = m[w])
            }
            var b = n.header.headers.custom,
              k = Object.keys(b);
            if (k.length)
              for (var x = k, O = Array.isArray(x), C = 0, x = O ? x : x[Symbol.iterator]();;) {
                var S;
                if (O) {
                  if (C >= x.length)
                    break;
      ...
      B = void 0,
      z = void 0; -
    1 !== (B = L.indexOf("Opera")) && (q = "Opera",
        U = L.substring(B + 6),
        -1 !== (B = L.indexOf("Version")) && (U = L.substring(B + 8))),
      -1 !== (B = L.indexOf("Edge")) ? (q = "Microsoft Edge",
        U = L.substring(B + 5)) : -1 !== (B = L.indexOf("MSIE")) ? (q = "Microsoft Internet Explorer",
        U = L.substring(B + 5)) : -1 !== (B = L.indexOf("Chrome")) ? (q = "Chrome",
        U = L.substring(B + 7)) : -1 !== (B = L.indexOf("Safari")) ? (q = "Safari",
        U = L.substring(B + 7),
        -1 !== (B = L.indexOf("Version")) && (U = L.substring(B + 8))) : -1 !== (B = L.indexOf("Firefox")) && (q = "Firefox",
        U = L.substring(B + 8)),
      -1 !== (z = U.indexOf(";")) && (U = U.substring(0, z)),
      -1 !== (z = U.indexOf(" ")) && (U = U.substring(0, z)),
      -1 !== (z = U.indexOf(")")) && (U = U.substring(0, z));
    for (var V = /Mobile|htc|mini|Android|iP(ad|od|hone)/.test(j) ? "wap" : "web", W = [{
        s: "Windows 10",
    ...
    switch (/Windows/.test(I) && (F = o(/Windows (.*)/, I),
        I = "windows"),
      I) {
      case "Mac OS X":
        F = o(/Mac OS X (10[\.\_\d]+)/, L),
          I = "mac";
        break;
      case "Android":
        F = function (e) {
            var t = o(/Android ([\.\_\d]+)/, e);
            return t || (t = o(/Android\/([\.\_\d]+)/, e)),
              t
          }(L),
          I = "android";
        break;
      case "iOS":
        F = (F = /OS (\d+)_(\d+)_?(\d+)?/.exec(j)) ? F[1] + "." + F[2] + "." + (0 | F[3]) : "",
          I = "ios"
    }
    var H = {
        screen_size: A,
    ...
    var Y = {
        ...
        isSupportLS: function () {
          try {
            return localStorage.setItem("_____tea-sdk-test-key", "hi"),
      ...
      X = function () {
        function e() {
          ...
          a(this, e);
          var n = !t && Y.isSupportLS;
          this._storage = n ? Y : new G
        }
      ...
      ee = function e() {
        ...
        s(this, e),
          ...
          this.info = function (e) {
            ...
            if (t.isLog) {
              var i;
              (i = console).log.apply(i, [t.prefix + e].concat(r))
            }
          },
          this.warn = function (e) {
            ...
            if (t.isLog) {
              var i;
              (i = console).warn.apply(i, [t.prefix + e].concat(r))
            }
          },
          this.error = function (e) {
            ...
            if (t.isLog) {
              var i;
              (i = console).error.apply(i, [t.prefix + e].concat(r))
            }
          },
          this.dir = function () {
            if (t.isLog) {
          ...
          this.logJSON = function (e) {
            "object" === (void 0 === e ? "undefined" : Z(e)) && t.isLog && t.info("", JSON.stringify(e, null, 2))
          },
      ...
      re = new Date,
      oe = re.getTimezoneOffset(),
      ie = parseInt(-oe / 60, 10),
      ae = 60 * oe,
      se = void 0;
    try {
      se = "3.2.10"
    ...
    var ue = function (e) {
        function t() {
          u(this, t);
          var n = l(this, e.call(this));
          return n.initClientEnv = function () {
              n.set("os_name", H.os_name),
                n.set("os_version", H.os_version),
                n.set("device_model", H.device_model),
                n.set("platform", H.platform),
                n.set("sdk_version", se),
                n.set("browser", H.browser),
                n.set("browser_version", H.browser_version),
                n.set("language", H.language),
                n.set("timezone", ie),
                n.set("tz_offset", ae),
                n.set("resolution", H.screen_width + "x" + H.screen_height),
                n.set("screen_width", H.screen_width),
                n.set("screen_height", H.screen_height),
                n.set("referrer", H.referrer),
                n.set("referrer_host", H.referrer_host),
                n.set("utm_source", H.utm_source),
                n.set("utm_medium", H.utm_medium),
                n.set("utm_campaign", H.utm_campaign),
                n.set("utm_term", H.utm_term),
                n.set("utm_content", H.utm_content)
            },
            n.initClientEnv(),
            n
        }
      ...
      ce = function () {
        ...
        return e.prototype.isString = function (e) {
          ...
          e.prototype.isFalse = function (e) {
            return "" === e || void 0 === e || null === e || "null" === e || "undefined" === e || 0 === e || !1 === e || NaN === e
          },
          ...
          return n.init = function (e) {
            ...
            n.transferFromCookie = function () {
              var e = n.tokensCacheKey,
                t = ve("tt_webid"),
                r = ve("__tea_sdk__ssid"),
                o = ve("__tea_sdk__user_unique_id");
              if (fe.isLowIE()) {
                if (t) {
                  var i = {
                    web_id: t,
            ...
            n.verifyTokens = function (e) {
              ...
              if (r.user_unique_id === n.realUuid && r.ssid && r.web_id)
                ...
                var o = he({}, n.getUserTokens(), {
                  user_unique_id: n.realUuid
                });
                if (n.storageClient.setItem(t, o),
                  fe.isLowIE())
                  return n.unlock(),
                    !1;
            ...
            n.mergeEnv = function () {
              var e = n.get(),
                t = le.get(),
                r = he({}, e.user),
                o = he({}, t.header.headers.custom, e.header.headers.custom),
                i = he({}, t.header.headers, e.header.headers, {
                  custom: o
                }),
                a = he({}, t.header, e.header);
              return {
                user: r,
                header: he({}, a, {
      ...
      xe = function (e, t, n, r) {
        try {
          var o = e.split("v1")[0];
          if (!o)
            return void r(e, t, $.NO_URL_PREFIX);
          ...
          r(e, t, $.IMG_CATCH_ERROR, n.message)
        }
      },
      Ee = function (e) {
        var t = e.url,
          ...
          s = n;
        if (window.XDomainRequest)
          return void xe(t, s, r, o);
        if (a)
          return window.navigator && window.navigator.sendBeacon ? (i(),
            void(window.navigator.sendBeacon(t, JSON.stringify(s)) ? r() : o(t, n, $.BEACON_STATUS_FALSE))) : void xe(t, s, r, o);
        var u = new XMLHttpRequest;
        u.open("POST", t + "?rdn=" + Math.random(), !0),
          u.onload = function () {
            r(t, s, u.responseText)
          },
          u.onerror = function () {
            u.abort(),
              o(t, s, $.XHR_ON_ERROR)
        ...
        function t(n) {
          ...
          r.addListener = function () {
            ...
            r.event = function () {
              ...
              r.memoryCacheManager.setItem(r.evtDataCacheKey, o),
          ...
          return r.init(n),
            r.maxBatchNum = s,
            r.waitForBatchTime = l,
            r.isReady = !1,
            r.addListener(),
            r.enableDebugMode(!!o),
            r.memoryCacheManager = new X(!0),
            r.eventStorage = new _e({
              disable_storage: i
            }),
      ...
      Le = function e(t) {
        ...
        k(this, e),
          ...
          this.config = function (e) {
            fe.isObj(e) || n.logger.throw("config 参数必须是 {} 的格式"),
              ...
              switch (s) {
                ...
                case "disable_ssid":
                  n.logger.deprecated("(disable_ssid)请通过init函数来设置。"),
                    u && (n.logger.info("ssid已禁用，设置user_unique_id不会请求ssid接口。"),
                      n.channel.isSsidDisabled = u);
                  break;
                case "disable_auto_pv":
                  u && (n.logger.info("已禁止默认上报predefine_pageview事件，需手动上报。"),
                    n._autoSendPV = !1);
                  break;
                case "_staging_flag":
                  "" + u == "1" && n.logger.info("根据_staging_flag设置，数据将会上报到stag 表。"),
          ...
          this.event = function () {
            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
              t[r] = arguments[r];
            var o = fe.isBoolean(t[t.length - 1]),
              i = !!o && t[t.length - 1],
              a = o ? t.slice(0, t.length - 1) : t,
              s = a[0],
              u = [];
            fe.isArray(s) ? u = a : u[0] = a,
              u = u.map(function (e) {
          ...
          this._autoSendPV = !0,
          this.name = t,
          this.logger = new ee(t)
      };
    Le.exportMethods = ["init", "config", "send", "start", "predefinePageView"];
    var Re = function e(t) {
        var n = this;
        return x(this, e),
          this._exportCollect = function () {
            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
              t[r] = arguments[r];
            if (n._isQueueProcessed)
              return void n._executeCmd.apply(n, t);
            n.cmdQueue.push(t),
              n._processCmdQueue()
          },
          this._processCmdQueue = function () {
            if (0 !== n.cmdQueue.length) {
              ...
              1 !== e && (n._isQueueProcessed = !0,
                n._executeCmd.apply(n, n.cmdQueue[e]),
                n.cmdQueue.forEach(function (t, r) {
          ...
          this._executeCmd = function () {
            for (var e = arguments.length, t = Array(e), r = 0; r < e; r++)
              t[r] = arguments[r];
            var o = t[0];
            if (Le.exportMethods.indexOf(o) > -1) {
              var i;
              (i = n.colloctor)[o].apply(i, t.slice(1))
            } else {
              var a;
          ...
          this.cmdQueue = [],
          this.colloctor = new Le(this.name),
      ...
      Fe = function (e) {
        ...
        if (1 === r.length)
          ...
          "event" === r[0] ? Ie("default").push([t, n]) : Ie(r[0]).push([r[1], n]);
        else if (3 === r.length) {
          var o = r[0],
            i = [r[1], r[2]].join(".");
          Ie(o).push([i, n])
      ...
      Ue = function () {
        Be.q.forEach(function (e) {
            var t = [].slice.call(e);
            fe.isArray(t[0]) ? t.forEach(function (e) {
              Fe(e)
            }) : Fe(t)
          }),
    ...
    Be.q = [],
      Be.l = +new Date,
      Be._instanceMap = De,
      Be._instanceCmdMap = Ne,
      Be.init = Be.bind(null, "init"),
      Be.config = Be.bind(null, "config"),
      Be.send = Be.bind(null, "send"),
      Be.start = Be.bind(null, "start"),
      Be.predefinePageView = Be.bind(null, "predefinePageView"),
      function (e) {
    ...
    function o() {
      a.default.init({
        ...
        a.default.config({
          evtParams: {
            from: u.request("from") || "",
            utm_source: u.request("utm_source") || "",
            utm_medium: u.request("utm_medium") || "",
            hostname: window.location.hostname,
            update_version_code: u.request("update_version_code") || "",
            app_name: u.request("app") || u.request("app_name") || "",
            channel: u.request("channel") || "",
            version_code: u.request("version_code") || "",
            device_type: u.request("device_type") || "",
            os_version: u.request("os_version") || "",
            device_id: u.request("device_id") || "",
            aid: u.request("aid") || "",
            is_inapp: c.default.is_inapp
          }
        }),
        a.default.send(),
        (0,
          a.default)("pageview"),
        window.Tea = a.default
    }
    Object.defineProperty(t, "__esModule", {
        value: !0
      }),
        ...
        return (0,
          ...
          (0,
            ...
            value: function (e) {
              ...
              }, e.title), m.default.createElement("div", {
                className: "item_info"
              }, m.default.createElement("span", {
                className: "hot_label space"
              }, "热"), m.default.createElement("span", {
                className: "src space"
              }, e.src))), m.default.createElement("div", {
      ...
      return (0,
        ...
        (0,
          ...
          value: function () {
            ...
            }, t ? null : m.default.createElement("div", {
              className: "top_bar"
            }, m.default.createElement("div", {
              className: "abs_m"
            }, m.default.createElement("a", {
            ...
            }, "返回") : m.default.createElement("div", {
              className: "abs_l"
            }, !n && m.default.createElement(b.default, null)), this.props.showAuditBtn ? m.default.createElement("span", {
              className: "abs_r",
              onClick: function () {
                return e.props.onClickShowAuditInfo()
              }
            }, "联系我们") : m.default.createElement("div", {
              className: "abs_r"
            }, m.default.createElement("a", {
              href: y.default.appendQuery("//m.toutiao.com/search/", "need_open_window=1"),
      ...
      var r = n("QVlm"),
        ...
        a = function (e, t) {
          ...
          function i(t) {
            ...
            f.push([
              ["A" + i, i].join(","), "0", [t.endDegree - t.startDegree > 180 ? "1" : "0", "1"].join(","), [s, u].join(",")
            ].join(" "));
            var d = f.join(" ");
            e(t.pathObj).attr("d", d).css("stroke", t.color),
        ...
        s = function (e, t) {
          ...
          return v.prototype = {
              ...
              if (!this.isRefreshing) {
                ...
                this.options.needRefresh(n),
                  this.options.onRelease().then(function () {
                    o.options.needRefresh() ? (t._vis_opt_queue = t._vis_opt_queue || [],
                      t._vis_opt_queue.push(function () {
                        _vis_opt_goal_conversion(13359)
                      }),
                      o.isRefreshing = !0,
                      o.refreshTimes += 1,
                      o.options.doRefresh().always(function () {
                        o.reset()
                      })) : (o.reset(),
                      o.options.noop())
                  })
            ...
            _onRelease: function () {
              if (this.transitionDefer = e.Deferred(),
                this.pullTipExist()) {
            ...
            canvasObj: function () {
              ...
              function u() {
                if (!m) {
                  ...
                  if (!T && (o({
                    ...
                    if (E.closePath(),
                      U = "erase" !== B ? I : P,
                      "draw" === (B = "erase" !== B ? "erase" : "draw")) {
                      D = U.color;
                      var d = t(D);
                      U.color = R[d],
                        U.startAngle = (U.startAngle - z) % 360,
                        F = U.startAngle,
                        V = n(F)
                    } else
                      F = U.startAngle = P.startAngle
                }
              }
              ...
              function l(e) {
                if (!m) {
                  var t = P.speed,
                    ...
                    o = R[0];
                  if (!isNaN(e)) {
                    e = Math.min(k.minRefreshDistance - c, e);
                    var i = e / (k.minRefreshDistance - c);
                    t = (V - p) * i - P.startAngle
                  }
                  r += t,
                    q = r,
                    h({
              ...
              function d() {
                ...
                return s(function e() {
                    if (o >= 0) {
                      ...
                      o -= n * (t - i),
                        i = t;
                      var u = o / (k.minRefreshDistance - c),
                        l = (V - p) * u - P.startAngle,
                        f = q - l;
                      f = Math.min(f, q),
                        h({
                          start: f,
              ...
              function h(t) {
                ...
                isNaN(n) || (o *= u,
                  ...
                  T ? a.drawArc({
                    ...
                    endDegree: t.end,
                    arrowSize: o,
                    arrowObj: e(x).find("#markerArrow"),
                    pathObj: e(x).find("#svgPath"),
                    color: t.color
                  }) : (E.strokeStyle = t.color,
                    E.fillStyle = t.color,
                    i.drawArcedArrow(E, O, C, S, w(t.start), w(t.end), !1, 1, 2, w(45), o, A, s))
              }
              ...
              function g() {
                var e = v(k.$pullTip.css("transform"));
                if (!(e < c)) {
                  var t = f,
                    n = e / t,
                    r = e,
              ...
              function _(t) {
                var n = 1 * t / (k.minRefreshDistance - c);
                e(x).css("opacity", n)
              }

              function y(e, t) {
                var n = e;
                t || (n = Math.max(0, (e - c) / k.minRefreshDistance * 360)),
              ...
              return {
                init: function (e, t) {
                  this.reset(),
                    W = 0,
                    j = !1,
                    x = e.find("#load-tip-svg")[0] || e.find("#load-tip-canvas")[0],
                    E = x.getContext ? x.getContext("2d") : x,
                    T = !x.getContext,
                    q = F = 0,
                    P.startAngle = I.startAngle = 0,
                    V = n(F),
                    N = 1,
                    P.color = R[N],
                    B = "draw",
            ...
            movePullTip: function (e, t, n) {
              if (this.pullTipExist()) {
                ...
                this.$pullTip[0].style.webkitTransition = t || "none",
                  ...
                  0 === e ? this.canvasObj.clearCurrent() : e > c && (this.shouldRefresh ? this.isRefreshing || !0 === n || this.canvasObj.rotate(e) : (e <= d() - 5 && this.canvasObj.rotate(e),
            ...
            removePullTip: function (t) {
              if (this.pullTipExist())
                if (t) {
                  ...
                  this.$pullTip[0].removeEventListener("webkitTransitionEnd", this.onTransitionEnd, !1),
                  this.$pullTip.remove(),
                  this.$pullTip = null,
    ...
    (function (t, n) {
      ...
      ! function (t, n) {
        ...
        return function (e) {
          ...
          function i(e, n, r) {
            if (r.Update || (r = new t.TemplateError(r)),
              r.Update(e),
              !n) {
              var o = r;
          ...
          function a(e, t, n) {
            ...
            e instanceof Error && (o = e,
              ...
              Object.setPrototypeOf ? (r = new Error(e),
                Object.setPrototypeOf(r, a.prototype)) : (r = this,
            ...
            return Object.defineProperty(r, "stack", {
              ...
              r.Update = function (e) {
                ...
                return i.firstUpdate && (i.lineno && i.colno ? t += " [Line " + i.lineno + ", Column " + i.colno + "]" : i.lineno && (t += " [Line " + i.lineno + "]")),
                  t += "\n ",
                  i.firstUpdate && (t += " "),
                  i.message = t + (i.message || ""),
                  i.firstUpdate = !1,
                  i
              },
              r
          ...
          function h(e) {
            ...
            if (!e)
              return t;
            for (var n = e.length, r = p(arguments).slice(1), o = -1; ++o < n;)
              -
              1 === w(r, e[o]) && t.push(e[o]);
            return t
          }
          ...
          function v(e, t, n) {
            if (null != e)
              if (O.forEach && e.forEach === O.forEach)
                e.forEach(t, n);
          ...
          t.hasOwnProp = r,
            t._prettifyError = i,
            Object.setPrototypeOf ? Object.setPrototypeOf(a.prototype, Error.prototype) : a.prototype = Object.create(Error.prototype, {
              constructor: {
                value: a
              }
            }),
          ...
          function r(e, t, n) {
            ...
            return function () {
              ...
              var l, c = s(i),
                f = a(i);
              if (c > e.length)
                l = i.slice(0, e.length),
                i.slice(l.length, c).forEach(function (e, n) {
                  n < t.length && (f[t[n]] = e)
                }),
                l.push(f);
              else if (c < e.length) {
          ...
          function f(e, t) {
            return e = void 0 !== e && null !== e ? e : "",
              !t || e instanceof u || (e = w.escape(e.toString())),
              e
          }

          function d(e, t, n) {
            if (null === e || void 0 === e)
              throw new w.TemplateError("attempted to output null or undefined value", t + 1, n + 1);
            return e
          }
          ...
          function v(e, t, n) {
            return e.lineno ? e : new w.TemplateError(e, t, n)
          }

          function g(e, t, n, r) {
            if (w.isArray(e)) {
              var o = e.length;
              w.asyncIter(e, function (e, r, i) {
                switch (t) {
                  case 1:
                    n(e, r, o, i);
                    break;
              ...
              w.asyncFor(e, function (e, t, r, o, i) {
                n(e, t, r, o, i)
              }, r)
          }
          ...
          function y(e) {
            return "object" != typeof e || null === e || w.isArray(e) ? e : k && Symbol.iterator in e ? b(e) : e
          }
          var w = n(1),
            b = Array.from,
            k = "function" == typeof Symbol && Symbol.iterator && "function" == typeof b,
            x = function () {
              function e(e, t) {
                this.variables = {},
                  this.parent = e,
              ...
              return t.set = function (e, t, n) {
                  var r = e.split("."),
                    o = this.variables,
                    i = this;
                  if (n && (i = this.resolve(r[0], !0)))
                    return void i.set(e, t);
          ...
          function s(e, t, n) {
            ...
            return u._assign(r.prototype, n),
              r
          }
          var u = n(1),
            l = function () {
          ...
          function r(e, t) {
            ...
            return c.FileSystemLoader ? n = new c.FileSystemLoader(e, {
              ...
              o = new s(n, t),
              t && t.express && o.express(t.express),
              o
          }
          var o, i = n(1),
            a = n(7),
          ...
          var i = n(8),
            ...
            l = n(12),
            c = n(3),
            f = c.FileSystemLoader,
            d = c.WebLoader,
            p = c.PrecompiledLoader,
            h = n(13),
            m = n(14),
            v = n(5),
            g = n(2),
            ...
            k = function (e) {
              ...
              return n.init = function (e, t) {
                  ...
                  t = this.opts = t || {},
                    ...
                    this.loaders = [],
                    e ? this.loaders = s.isArray(e) ? e : [e] : f ? this.loaders = [new f("views")] : d && (this.loaders = [new d("/views")]),
                    ...
                    this.extensions = {},
                    this.extensionsList = [],
                    s._entries(l).forEach(function (e) {
                      var t = e[0],
                        r = e[1];
                ...
                n.getTemplate = function (e, t, n, r, o) {
                  ...
                  if (e && e.raw && (e = e.raw),
                    ...
                    for (var l = 0; l < this.loaders.length; l++) {
                      ...
                      if (u = c.cache[this.resolveTemplate(c, n, e)])
                        break
                    }
                  }
                  if (u)
                  ...
                  var f, d = function (n, a) {
                    if (a || n || r || (n = new Error("template not found: " + e)),
                      n) {
                      if (o)
                        return void o(n);
                      throw n
                    ...
                    var s;
                    a ? (s = new E(a.src, i, a.path, t),
                        a.noCache || (a.loader.cache[e] = s)) : s = new E(b, i, "", t),
                      o ? o(null, s) : f = s
                  };
                ...
                n.renderString = function (e, t, n, r) {
                  return s.isFunction(n) && (r = n,
                      n = {}),
                    n = n || {},
                    new E(e, this, n.path).render(t, r)
                },
            ...
            E = function (e) {
              ...
              return n.init = function (e, t, n, r) {
                ...
                n.render = function (e, t, n) {
                  ...
                  var u = new x(e || {}, this.blocks, this.env),
                    l = t ? t.push(!0) : new y;
                  l.topLevel = !0;
                  var c = null,
                    f = !1;
                  return this.rootRenderFunc(this.env, u, l, g, function (e, t) {
                      if (!f)
                        if (e && (e = s._prettifyError(r.path, r.env.opts.dev, e),
                            f = !0),
                          n)
                          i ? o(n, e, t) : n(e, t);
                        else {
                ...
                n.getExported = function (e, t, n) {
                  ...
                  r.topLevel = !0;
                  var o = new x(e || {}, this.blocks, this.env);
          ...
          e.exports = o,
            i.prototype.call = function () {
              try {
                ...
                o.onerror ? o.onerror(e) : (u.push(e),
                  l())
              } finally {
                this.task = null,
                  s[s.length] = this
          ...
          function i(e, t, n) {
            ...
            for (r = 0; r < e.length; r++)
              r % t == 0 && i.length && (o.push(i),
                i = []),
              i.push(e[r]);
            if (i.length) {
              if (n)
                for (r = i.length; r < t; r++)
                  i.push(n);
              o.push(i)
            }
            return o
          ...
          function a(e) {
            e = r(e, "");
            var t = e.toLowerCase();
            return z.copySafeness(e, t.charAt(0).toUpperCase() + t.slice(1))
          }
          ...
          function l(e, t, n) {
            ...
            return r.sort(function (e, n) {
                var r = e[i],
                  o = n[i];
                return t || (B.isString(r) && (r = r.toUpperCase()),
          ...
          function f(e) {
            return e instanceof z.SafeString ? e : (e = null === e || void 0 === e ? "" : e,
              z.markSafe(B.escape(e.toString())))
          }

          function d(e) {
            return e instanceof z.SafeString ? e : (e = null === e || void 0 === e ? "" : e,
              z.markSafe(e.toString()))
          }
          ...
          function m(e, t, n) {
            ...
            return z.copySafeness(e, a)
          }

          function v(e, t, n) {
            return t = t || "",
              n && (e = B.map(e, function (e) {
                return e[n]
              })),
              e.join(t)
          }
          ...
          function _(e) {
            var t = r(e, "");
            return void 0 !== t ? "function" == typeof Map && t instanceof Map || "function" == typeof Set && t instanceof Set ? t.size : !B.isObject(t) || t instanceof z.SafeString ? t.length : B.keys(t).length : 0
          }
          ...
          function y(e) {
            if (B.isString(e))
              return e.split("");
            if (B.isObject(e))
              return B._entries(e || {}).map(function (e) {
                return {
                  key: e[0],
                  value: e[1]
                }
          ...
          function b(e) {
            return null === e || void 0 === e ? "" : z.copySafeness(e, e.replace(/\r\n|\n/g, "<br />\n"))
          }
          ...
          function T(e, t, n, r) {
            ...
            if ("number" == typeof e && (e = "" + e),
              "string" != typeof e && !(e instanceof z.SafeString))
              return e;
            if ("" === t)
              return i = n + e.split("").join(n) + n,
                z.copySafeness(e, i);
            var a = e.indexOf(t);
            if (0 === r || -1 === a)
              return e;
            for (var s = 0, u = 0; a > -1 && (-1 === r || u < r);)
              i += e.substring(s, a) + n,
              s = a + t.length,
              u++,
              a = e.indexOf(t, s);
            return s < e.length && (i += e.substring(s)),
              z.copySafeness(o, i)
          }

          function O(e) {
            var t;
            return t = B.isString(e) ? y(e) : B.map(e, function (e) {
                return e
              }),
              t.reverse(),
              B.isString(e) ? z.copySafeness(e, t.join("")) : t
          }
          ...
          function L(e) {
            ...
            return z.copySafeness(e, t.join(" "))
          }

          function R(e) {
            return z.copySafeness(e, e.replace(/^\s*|\s*$/g, ""))
          }
          ...
          function P(e) {
            ...
            return B.isString(e) ? t(e) : (B.isArray(e) ? e : B._entries(e)).map(function (e) {
              var n = e[0],
                r = e[1];
              return t(n) + "=" + t(r)
            }).join("&")
          ...
          function I(e, t, n) {
            ...
            return e.split(/(\s+)/).filter(function (e) {
              ...
              var n = e.match(V),
                o = n ? n[1] : e,
                i = o.substr(0, t);
              return K.test(o) ? '<a href="' + o + '"' + r + ">" + i + "</a>" : J.test(o) ? '<a href="http://' + o + '"' + r + ">" + i + "</a>" : W.test(o) ? '<a href="mailto:' + o + '">' + o + "</a>" : H.test(o) ? '<a href="http://' + o + '"' + r + ">" + i + "</a>" : e
            }).join("")
          }
          ...
          t.abs = Math.abs,
            ...
            t.slice = S,
            t.sum = M,
            t.sort = z.makeMacro(["value", "reverse", "case_sensitive", "attribute"], [], function (e, t, n, r) {
              var o = B.map(e, function (e) {
                return e
              });
              return o.sort(function (e, o) {
                  var i = r ? e[r] : e,
                    a = r ? o[r] : o;
                  return !n && B.isString(i) && B.isString(a) && (i = i.toLowerCase(),
                      a = a.toLowerCase()),
                    i < a ? t ? 1 : -1 : i > a ? t ? -1 : 1 : 0
                }),
                o
            }),
            t.string = A,
          ...
          function r() {
            ...
            function e() {
              i.contextOrFrameLookup = l,
                i.memberLookup = c,
                s && (s.prototype.assertType = r),
                u && (u.prototype.parseAggregate = o)
            }
            ...
            function t(e, t, n, r) {
              e = e || [],
                ...
                t < 0 && (t += e.length);
              for (var o = [], a = t; !(a < 0 || a > e.length) && !(r > 0 && a >= n) && !(r < 0 && a <= n); a += r)
                o.push(i.memberLookup(e, a));
              return o
            }
            ...
            var r, o, i = this.runtime,
              a = this.lib,
              s = this.compiler.Compiler,
              u = this.parser.Parser,
              l = (this.nodes,
                this.lexer,
                i.contextOrFrameLookup),
              c = i.memberLookup;
            s && (r = s.prototype.assertType),
              u && (o = u.prototype.parseAggregate),
            ...
            var f = {
              ...
              d = {
                ...
                update: function (e) {
                  return a._assign(this, e),
                    null
                }
              };
            return d.iteritems = d.items,
              d.itervalues = d.values,
              d.iterkeys = d.keys,
              i.memberLookup = function (e, r, o) {
                return 4 === arguments.length ? t.apply(this, arguments) : (e = e || {},
                  a.isArray(e) && n(f, r) ? f[r].bind(e) : a.isObject(e) && n(d, r) ? d[r].bind(e) : c.apply(this, arguments))
              },
              e
          }
          e.exports = r
  ...
  "4/IU": function (e, t, n) {
    ...
    (function (t) {
      var r = n("gT+X"),
        ...
        s = function (e) {
          ["home", "detail", "mediaProfile"].indexOf(e.type || "home") > -1 ? o.androidLocalServer(e).then(function (e) {}, function (t) {
            a(e.nativeLink)
          }) : a(e.nativeLink)
        },
        u = function (e) {
      ...
      return (0,
        ...
        (0,
          ...
          value: function () {
            ...
            }, m.default.createElement("p", null, "Copyright © 2017 头条日报 版权所有 京ICP备17027596 "), m.default.createElement("p", null, "北京抖动青春科技有限公司"), m.default.createElement("p", null, "北京市海淀区信息路甲28号C座（二层）02A室-345号"), m.default.createElement("p", null, "010-58341810"))
          }
        }]),
        t
    }(h.Component);
  ...
  "84PZ": function (e, t, n) {
    ...
    (function (t) {
      ...
      function i(e) {
        ...
        var n = {
            openurl: e.openUrl,
            postdata: [e.postData || f.default.getAppTrackData()]
          },
          r = m.default.appendQuery(t, "append=" + encodeURIComponent((0,
            l.default)(n))),
          o = document.createElement("a");
        return o.href = t,
          g.default.parse(o.search.slice(1)).append && (r = t),
          r
      }
      ...
      function s(e) {
        var t = e.downloadLink;
        if (p.default.os.android)
          if (p.default.browser.weixin) {
            ...
            value: function () {
              ...
              ! function (t, n, r, o, i) {
                ...
                var a = n.getElementsByTagName(r)[0],
                  s = n.createElement(r);
                s.async = !0,
                  "1" === _.default.request("_gtm") ? s.src = "//www.googletagmanager.com/gtm.js?id=" + i : s.src = "//s3a.pstatp.com/growth/fe_sdk/gtmsdk/" + i + ".js?v=" + window.gtmExpireTime,
                  s.onload = function () {
                    function t() {
                      var r;
                      if (r = window.isListPage ? window.ttGTM.list : v.default.browser.weixin ? window.ttGTM.weixin : window.ttGTM.detail,
                        window.ttGTM.xpromtOptions && (r.xpromt = window.ttGTM.xpromtOptions),
                        !r)
                        return void(--n && setTimeout(t, 10));
                      window.GTMValue = r,
  ...
  AJa0: function (e, t, n) {
    ...
    (function (t) {
      ...
      function i() {
        return !window.isListPage && x.default.browser.weixin
      }
      ...
      function u() {
        ...
        if (n && "1" === n) {
          var r = T.default.request(null, !0),
            o = location.hash,
            i = location.host,
            a = r,
      ...
      function l() {
        ...
        (navigator.userAgent.indexOf("ArticleStreamSdk") > -1 || "open" === T.default.request("utm_campaign")) && (e = "UA-28423340-11"),
      ...
      function f() {
        window.ga("set", "dimension1", "list"),
          x.default.browser.weixin ? window.ga("set", "dimension2", "weixin") : window.ga("set", "dimension2", "wap");
        var e = T.default.request("wxshare_count");
        !isNaN(e) && e > 0 && window.ga("set", "dimension3", e);
        var t = T.default.request("isappinstalled");
        !isNaN(t) && t >= 0 && window.ga("set", "dimension4", t - 0 ? 1 : 0);
        var n = T.default.request("app");
        n && window.ga("set", "dimension5", n);
        var r = location.host;
        window.ga("set", "dimension6", r);
        var o = T.default.request("utm_source") || "",
          i = o + "_" + (T.default.request("from") || "");
        (o || T.default.request("from")) && window.ga("set", "dimension7", i);
        var a = T.default.request("share_type");
  ...
  Ah8g: function (e, t, n) {
    ...
    e.exports = function (e, t, n, i) {
      ...
      u > 0 && l > u && (l = u);
      for (var c = 0; c < l; ++c) {
        var f, d, p, h, m = e[c].replace(s, "%20"),
          v = m.indexOf(n);
        v >= 0 ? (f = m.substr(0, v),
            d = m.substr(v + 1)) : (f = m,
            d = ""),
        ...
        return (0,
          ...
          (0,
            ...
            value: function () {
              ...
              t = v.default.browser.weixin ? "//d.toutiao.com/2uYv/" : t,
                ttBannerConf = {
                  pos: "bottom",
                  downloadLink: t,
                  callback: function () {
                    this._el.on("click", ".download", function () {
                      window.maevent("bottom_banner", "download"),
                        v.default.os.android && w.default.jumpToNativeapp({
                          nativeLink: _.default.getNativeLink({})
                        })
                    })
                  },
                  isGrowthWap: !0
              ...
              var n = document.createElement("script"),
                r = Date.now();
              n.setAttribute("src", "//s3.pstatp.com/growth/fe_sdk/bannersdk/loader.js?t=" + r),
  ...
  Bbyf: function (e, t, n) {
    ...
    (0,
      a.render)(i.default.createElement(u.default, {
      topMenuInfo: g,
      Header: c.default,
      TopMenu: d.default,
...
*/
  ...
  "Es/p": function (e, t, n) {
    ...
    var o = n("iltz"),
      ...
      T = function (e) {
        ...
        return m.default.createElement("a", {
          ...
          className: "dotdot line3"
        }, t.title), m.default.createElement(y.default, {
          src: t.large_image_url
        }), m.default.createElement("span", {
          className: "video-btn"
        })), m.default.createElement("div", {
          className: "item_info"
        }, m.default.createElement("div", null, t.hot && m.default.createElement("span", {
          className: "hot_label space"
        }, "热"), t.recommend && m.default.createElement("span", {
          className: "recommend_label space"
        }, "荐"), t.subject_label && m.default.createElement("span", {
          className: "subject_label"
        }, " ", t.subject_label), !t.subject_label && m.default.createElement("span", {
          className: n
        }, t.source), m.default.createElement("span", {
          className: "cmt space"
        }, "评论 ", t.comment_count), m.default.createElement("span", {
          className: "time",
          title: t.datetime
    ...
    var O = function (e) {
      ...
      return (0,
        ...
        (0,
          ...
          key: "handleClick",
          value: function (e) {
            window.maevent("feed", "", "click-" + e.index, this.props.currentChannel),
              (0,
                k.actionLog)({
            ...
            var t = e.source_url;
            E.default.request("from_weixinlist") && (t = E.default.appendQuery(t, "from_weixinlist=" + E.default.request("from_weixinlist")));
            var n = location.search.substring(1);
            n && (t = E.default.appendQuery(t, n)),
              location.href = t
          }
        }, {
          key: "render",
    ...
    O.propTypes = {
        datum: g.default.object,
        currentChannel: g.default.string
      },
      e.exports = O
  },
  FKII: function (e, t, n) {
        ...
        i = {
          ...
          initClickEvents: function (e) {
            ...
            t(e).parents("section").find(".article_link").click(function (e) {
              ...
              return n.sendClickEvent(r, "click", o, i, function () {
                  ...
                  var e, f;
                  if (t(s).attr("ad-load")) {
                    var d = t.cookie("utm_source") || "",
                      p = t.cookie("utm_campagin") || "",
                      h = t.cookie("utm_media") || "",
                      m = t.cookie("utm_term") || "",
                      v = t.cookie("utm_content") || "",
                      g = encodeURIComponent(t(s).find(".download").attr("ad-url"));
                    if (l.hasClass("download"))
                      e = "feed_download_ad",
                      f = "click_start",
                      n.sendClickEvent(r, f, e, i),
                      window.location.href = c;
                    else if ((l.hasClass("text_info") || l.parent().hasClass("text_info")) && (e = "feed_download_ad",
                        f = "click_card",
                        n.sendClickEvent(r, f, e, i)),
                      u) {
                      var _ = "value=" + r + "&log_extra=" + i + "&tag=" + o + "&utm_source=" + d + "&utm_campagin=" + p + "&utm_medium=" + h + "&utm_term=" + m + "&utm_content=" + v + "&is_ad_event=1&category=wap&download_url=" + g;
                      window.location.href = -1 === u.indexOf("?") ? u + "?" + _ : u + "&" + _
                    } else
                      window.location.href = t(s).find(".download").attr("ad-url")
                  } else
                    t(s).attr("ad-call") && (l.hasClass("phone") ? (e = "feed_call",
                      f = "click_call",
                      n.sendClickEvent(r, f, e, i),
                      window.location.href = "tel:" + c) : ((l.hasClass("text_info") || l.parent().hasClass("text_info")) && (e = "feed_call",
                        f = "click_card",
                        n.sendClickEvent(r, f, e, i)),
                      window.location.href = u || "tel" + t(s).find(".phone").attr("ad-url")))
                }),
                !1
            })
          },
          ...
          sendShowEvent: function (e, n, r, i) {
            ...
            var s, u, l = "section" + i.index(),
              c = l + e,
              f = this;
            if (-1 !== this.ad_ids.indexOf(c))
              return this;
            this.ad_ids.push(c);
            a(e, "show", n, r);
            var d = i.find(".article_link");
            return d.attr("ad-load") ? (s = "card_show",
                u = "feed_download_ad",
                a(e, s, u, r)) : d.attr("ad-call") && (s = "card_show",
                u = "feed_call",
                a(e, s, u, r)),
              this
          },
          sendTrackEvent: function (e, n) {
            ...
            return r.length || (t("body").append("<iframe src='' height='0' width='0' id='ad_track' style='position:absolute; top:-10px'/>"),
                r = t("iframe#ad_track")),
              r.attr("src", n),
          ...
          _inView: function (e) {
            if (!this._isVisbile(e))
              return !1;
            var t = e.getBoundingClientRect(),
              n = window.innerHeight || document.documentElement.clientHeight;
            return t.top > 0 && t.top <= n || (this.delAdId(e),
              !1)
          },
          ...
          _pollLogNodes: function () {
            for (var e = this.attribute || "alt_src", t = document.querySelectorAll("span[" + e + "]"), n = 0, r = t.length; n < r; ++n) {
              var o = t[n];
              if (this.initClickEvents(o),
                o && this._inView(o))
                return "undefined" != typeof indexFlow && window.indexFlow.storeFlow(),
                  this.pushAdQueue(o),
                  !1
            }
          },
        ...
        return (0,
          ...
          (0,
            ...
            value: function () {
              ...
              }, this.state.inView ? g.default.createElement("img", (0,
  ...
  JBQp: function (e, t, n) {
    ...
    e.exports = !u || n("eHtw")(function () {
        ...
        for (var n = a(e), u = arguments.length, l = 1, c = o.f, f = i.f; u > l;)
          for (var d, p = s(arguments[l++]), h = c ? r(p).concat(c(p)) : r(p), m = h.length, v = 0; m > v;)
  ...
  LC85: function (e, t, n) {
    ...
    _.serializeObject = o,
      ...
      l.prototype._parseBody = function (e) {
        ...
        return this.req._parser ? this.req._parser(this, e) : (!t && u(this.type) && (t = _.parse["application/json"]),
      ...
      c.prototype.type = function (e) {
        return this.set("Content-Type", _.types[e] || e),
          this
      },
      c.prototype.accept = function (e) {
        return this.set("Accept", _.types[e] || e),
          this
      },
      ...
      c.prototype._end = function () {
        ...
        if (this._withCredentials && (t.withCredentials = !0),
          ...
          var o = this._header["content-type"],
            i = this._serializer || _.serialize[o ? o.split(";")[0] : ""];
          !i && u(o) && (i = _.serialize["application/json"]),
            i && (n = i(n))
        }
      ...
      g = function (e) {
        ...
        return a(t, e),
          ...
          t.prototype.componentWillReceiveProps = function (e) {
            var t = (0,
                m.getChildMapping)(e.children),
              n = this.state.children;
            this.setState({
              children: (0,
                m.mergeChildMappings)(n, t)
            });
            for (var r in t) {
            ...
            for (var n in this.state.children)
              ! function (n) {
                ...
                if (r) {
                  ...
                  i === r && o && (a = (0,
                      l.default)(r.ref, a)),
                    t.push(f.default.cloneElement(i, {
                      key: n,
                      ref: a
                    }))
                }
      ...
      a = function (e, t) {
        for (var n = {}, r = t.ignoreQueryPrefix ? e.replace(/^\?/, "") : e, a = t.parameterLimit === 1 / 0 ? void 0 : t.parameterLimit, s = r.split(t.delimiter, a), u = 0; u < s.length; ++u) {
          var l, c, f = s[u],
            d = f.indexOf("]="),
            p = -1 === d ? f.indexOf("=") : d + 1; -
          1 === p ? (l = t.decoder(f, i.decoder),
              c = t.strictNullHandling ? null : "") : (l = t.decoder(f.slice(0, p), i.decoder),
              c = t.decoder(f.slice(p + 1), i.decoder)),
        ...
        for (var r = t, o = e.length - 1; o >= 0; --o) {
          ...
          if ("[]" === a)
            ...
            var s = "[" === a.charAt(0) && "]" === a.charAt(a.length - 1) ? a.slice(1, -1) : a,
              u = parseInt(s, 10);
            !isNaN(u) && a !== s && String(u) === s && u >= 0 && n.parseArrays && u <= n.arrayLimit ? (i = [],
              i[u] = r) : i[s] = r
          }
          r = i
        }
  ...
  QVlm: function (e, t, n) {
    ...
    e.exports = function (e, t) {
      function n() {
        if (!i) {
          ...
          if (i = r.createElement("meta"),
            ...
            i.setAttribute("content", e + "initial-scale=" + t.scale + ", maximum-scale=" + t.scale + ", minimum-scale=" + t.scale + ", user-scalable=no"),
            o.firstElementChild)
      ...
      if (t.init = function (n) {
        ...
        a && f && (content = a.getAttribute("content"),
          content)) {
      ...
      return t.scaleLock = !1,
        t.changeScale = function (t, r) {
          ...
          if (r && (this.scaleLock = r),
            o.getBoundingClientRect().width > e.innerWidth) {
        ...
        e.addEventListener("pageshow", function (e) {
          e.persisted && (clearTimeout(c),
            window.noScaling || (c = setTimeout(t.changeScale.bind(t), 300)))
        }, !1),
        t.rem2px = function (e) {
  ...
  RvJg: function (e, t, n) {
    ...
    var J = function (e) {
      function t() {
        ...
        for (var i = arguments.length, a = Array(i), s = 0; s < i; s++)
          a[s] = arguments[s];
        return n = r = (0,
            g.default)(this, (e = t.__proto__ || (0,
        ...
        (0,
          ...
          value: function (e) {
            if (0 !== e.listData.length && 0 === this.props.listData.length && this.showMaterial()) {
              var t = this.props.GTMValue.adMaterialOptions,
                n = JSON.parse(I.default.getCookieForLocal("ad_material_options")) || {},
                r = (new Date).getTime() - t.adMaterialUpateTime;
              r >= 0 ? n.adMaterialChannels && I.default.setCookieForLocal("ad_material_options", (0,
                l.default)(t), 864e5 - r) : t = n;
          ...
          value: function () {
            ...
            e.updateTimeAgo(this.props.listData),
              ...
              "object" === (void 0 === B.default ? "undefined" : (0,
                i.default)(B.default)) && B.default.initShowEvents({
                attribute: "data-show"
              })
          }
        }, {
          ...
          value: function () {
            B.default.scrollChangeDisable = !1,
              B.default.scrollUpdate()
          }
        }, {
          key: "updateTimeAgo",
          value: function (e) {
            var t = I.default.cloneDeep(e);
            t.forEach(function (e) {
                var t = (0,
                  q.default)(e.datetime, {
                  daysAgoFormat: "MM-dd"
                });
                e.timeago = t
              }),
          ...
          value: function () {
            ...
            return !(!e || !e.adMaterialChannels) && (-1 !== e.adMaterialChannels.indexOf(I.default.hash("channel")) && !!e.adMaterials)
          }
        }, {
          key: "render",
          value: function () {
            ...
            return b.default.createElement("content", {
              ...
              return t.action_label = "click_" + ("__all__" === e.props.currentChannel ? "headline" : e.props.currentChannel),
                K.default.browser.liteh5 && K.default.os.ios && (t.source_url && (t.source_url = I.default.appendQuery(t.source_url, "need_open_window=1")),
                  t.url && (t.url = I.default.appendQuery(t.url, "need_open_window=1"))),
                t.showAdMaterial ? b.default.createElement(R.default, {
                  key: r,
                  datum: t.adMaterial
                }) : t.ad_id ? b.default.createElement(C.default, {
                  key: r,
                  datum: t
                }) : "video" === e.props.currentChannel || !0 === window.isVideoListPage ? b.default.createElement(M.default, {
                  key: r,
                  datum: t,
                  currentChannel: e.props.currentChannel
                }) : t.xpromt ? b.default.createElement(j.default, {
                  key: r,
                  datum: t
    ...
    J.propTypes = {
        GTMValue: x.default.object,
        listData: x.default.array,
        dispatch: x.default.func,
        currentChannel: x.default.string,
        tips: x.default.string,
        props: x.default.object,
        addADMaterial: x.default.func
      },
      e.exports = J
  },
  SJPe: function (e, t, n) {
      ...
      var e = function (e, t, n, r, o, i, a, s) {
          ...
          if (1 & l && (h = Math.cos(i) * o + t,
            ...
            h = Math.cos(a) * o + t,
              ...
              s ? (g = h - 10 * Math.cos(v),
                _ = m - 10 * Math.sin(v)) : (g = h + 10 * Math.cos(v),
                _ = m + 10 * Math.sin(v)),
              n(e, h - p * Math.sin(a), m + p * Math.cos(a), g - p * Math.sin(a), _ + p * Math.cos(a), u, 2, c, f)
          }
          e.restore()
        },
        n = function (t, n, r, o, i, a, s, u, l) {
          ...
          var c, f, d, p, h = "function" != typeof a ? e : a,
            ...
            v = (m - l / 3) / m;
          1 & s ? (c = Math.round(n + (o - n) * v),
              f = Math.round(r + (i - r) * v)) : (c = o,
              f = i),
            2 & s ? (d = n + (o - n) * (1 - v),
              p = r + (i - r) * (1 - v)) : (d = n,
              p = r),
    ...
    (function (t) {
      e.exports = function (e, t) {
        ...
        return i.prototype = {
          ...
          __move: function (e) {
            if (this.hasTouch) {
              ...
              if (this.direction === r.NONE) {
                ...
                o + n > this.options.minDistance && (this.direction = o > 1.73 * n ? r.LEFT_RIGHT : n > 1.73 * o ? this.distanceY < 0 ? r.UP : r.DOWN : r.NOOP,
          ...
          __end: function (e) {
            !this.hasTouch || r.LEFT_RIGHT !== this.direction && r.DOWN !== this.direction || (this.direction === r.LEFT_RIGHT && (e.preventDefault(),
                  this.options.onPullEnd(e, this.distanceX, r.LEFT_RIGHT)),
                this.direction === r.DOWN && this.isPull && (e.preventDefault(),
                  this.options.onPullEnd(e, this.distanceY, r.DOWN))),
              this.hasTouch = !1,
              this.isPull = !1
          }
        }, {
    ...
    ! function (e, t, n) {
      function r(e) {
        ...
        return t ? t && e && (s("__tasessionId", t, {
            ...
            f = !1) : (c = (new Date).getTime(),
            t = "" + o(9) + (new Date).getTime(),
            s("__tasessionId", t, {
              expires: 1800
            }),
            f = !0),
      ...
      function s(e, n, r) {
        ...
        i(a, r),
          a.expires && (o = new Date,
            o.setTime(o.getTime() + 1e3 * r.expires)),
      ...
      function f() {
        return this.bodyUsed = !1,
          this._initBody = function (e) {
            ...
            else if (g.arrayBuffer && g.blob && y(e))
    ...
    var r = n("6uqe"),
      ...
      u = function e(t, n, o, i, a, u, l, c, f, d, p, h) {
        ...
        for (var y = 0; y < g.length; ++y) {
          var w = g[y];
          a && null === m[w] || (v = Array.isArray(m) ? v.concat(e(m[w], o(n, w), o, i, a, u, l, c, f, d, p, h)) : v.concat(e(m[w], n + (f ? "." + w : "[" + w + "]"), o, i, a, u, l, c, f, d, p, h)))
        }
        return v
      };
    e.exports = function (e, t) {
      ...
      var _, y, w = o.formatters[a.format];
      ...
      for (var E = 0; E < _.length; ++E) {
        var T = _[E];
        f && null === n[T] || (b = b.concat(u(n[T], T, x, c, f, d ? p : null, y, h, m, v, w, g)))
      }
      var O = b.join(l),
      ...
      k = function (e) {
        ...
        return (0,
          ...
          (0,
            ...
            key: "componentDidMount",
            value: function () {
              !y.default.getCookieForLocal("show_msg") && this.setState({
                showMsg: !0
              })
            }
          }, {
            ...
            value: function () {
              this.setState({
                ...
                y.default.setCookieForLocal("show_msg", !0, 864e5),
            ...
            value: function () {
              ...
              }, this.state.showMsg && m.default.createElement("div", {
                className: "circle"
              }))
            }
          }]),
  ...
  YWnE: function (e, t, n) {
    ...
    function l() {
      ...
      if ("object" === (0,
          _.default)(arguments[0])) {
        for (var i in arguments[0])
          t[i] = arguments[0][i];
        var a = (0,
          v.default)(t).map(function (e) {
          return "h=" + t[e]
        }).join("&");
      ...
      y = function (e, t, n) {
        ...
        if (n.expires && ("number" == typeof n.expires || n.expires.toUTCString)) {
          ...
          "number" == typeof n.expires ? (u = new Date,
              u.setTime(u.getTime() + n.expires)) : u = n.expires,
      ...
      w = {
        vendor: function () {
          for (var e = ["O", "ms", "Moz", "Khtml", "Webkit", "webkit", ""], t = document.createElement("div"), n = e.length; n--;) {
            var r = e[n];
            if ((r ? r + "Transform" : "transform") in t.style)
              return r
          }
          return null
        },
        prefix: function (e, t) {
          if (null !== w.vendor()) {
            var n = w.vendor() ? "-" + w.vendor().toLowerCase() + "-" : "",
              r = w.vendor() || "";
            if (t) {
            ...
            return r + ("" !== w.vendor() ? e.charAt(0).toUpperCase() + e.substr(1) : e).replace(/(-[a-z])/g, function (e, t) {
              return e.charAt(1).toUpperCase()
            })
          }
        },
        canRun2d: function () {
          return null !== w.vendor()
        },
        canRun3d: function () {
          var e = document.createElement("div");
          if (!w.canRun2d() || !window.getComputedStyle)
            return !1;
          var t = w.prefix("transform");
          document.body.appendChild(e),
        ...
        canUsePageVisibility: function () {
          return null !== w.vendor() && void 0 !== document[w.prefix("hidden")]
        }
      },
      b = function () {
        return w.canUsePageVisibility() ? document[w.prefix("hidden")] ? "hidden" : "visible" : "unknown"
      };
    e.exports = {
      cookie: y,
      support: w,
    ...
    var o = n("iltz"),
      ...
      T = function (e) {
        var t = e.datum,
          ...
          o = (0,
            b.default)("dislike-news", "fr", {
            "mid-space": t.middle_mode
          }),
          i = (0,
            b.default)("item_detail", {
            desc: t.middle_mode
          });
        return m.default.createElement("a", {
          href: "javascript: void(0)",
          ...
          className: n
        }, t.title), t.more_mode && m.default.createElement("div", {
          className: "list_image"
        }, m.default.createElement("ul", {
          className: "clearfix"
        ...
        }))), t.large_mode && m.default.createElement("div", {
          className: "list_img_holder_large list_img_holder_large_fix"
        }, m.default.createElement(y.default, {
          src: t.large_image_url
        }), t.has_video && m.default.createElement("span", {
          className: "video-btn"
        })), m.default.createElement("div", {
          className: "item_info"
        }, m.default.createElement("div", null, t.is_stick && m.default.createElement("span", {
          className: "stick_label space"
        }, t.label || "置顶"), t.hot && m.default.createElement("span", {
          className: "hot_label space"
        }, "热"), t.recommend && m.default.createElement("span", {
          className: "recommend_label space"
        }, "荐"), t.subject_label && m.default.createElement("span", {
          ...
          className: "cmt space"
        }, "评论 ", t.comment_count), !t.middle_mode && m.default.createElement("span", {
          className: "time",
          title: t.datetime
        }, t.timeago), m.default.createElement("span", {
          "data-id": t.group_id,
          className: o
        })))), t.middle_mode && m.default.createElement("div", {
          className: "list_img_holder"
        }, m.default.createElement(y.default, {
          src: t.image_url
        }), t.has_video && m.default.createElement("span", {
      ...
      return (0,
        ...
        (0,
          ...
          value: function () {
            var e = this,
              t = this.props.datum;
            t.has_video && (t.large_mode = !1,
              t.middle_mode = !0,
              t.image_url = t.image_url || t.large_image_url,
              t.image_url && t.large_image_url || (t.middle_mode = !1));
            var n = (0,
              b.default)({
              middle_mode: t.middle_mode,
              has_action: !0,
              "item-hidden": t.honey
            });
            return m.default.createElement("section", {
  ...
  bChP: function (e, t, n) {
    ...
    function o(e) {
      ! function (e, t, n, r, o, i) {
        ...
        if (a.async = 1,
          a.src = "//s3.bytecdn.cn/ta/resource/v0/analytics.js?v=0.1.15",
    ...
    function a() {
      o(u.default.browser.weixin ? "941fa8db85144e" : "2016b6cb651225"),
        window.baevent = i
    }
    var s = n("gT+X"),
      u = function (e) {
  ...
  bVOP: function (e, t, n) {
    ...
    (function (t) {
      ...
      function a() {
        if (!T.default.browser.weixin)
          return !1;
        var e = C.default.request("isappinstalled") - 0,
          t = C.default.request("wxshare_count");
        return !(!e || t && !(t < 2))
      }
      ...
      function u(e, t) {
        if (t = void 0 !== t && t,
          window.ttGTM) {
          var n = null;
          return n = window.isListPage ? window.ttGTM.list : T.default.browser.weixin ? window.ttGTM.weixin : window.ttGTM.detail,
            n = n || {},
            e in n ? n[e] : t
        }
        return t
      ...
      function c(e) {
        var t, n = {
          ...
          r = e.app || C.default.request("app") || "news_article",
          o = 1;
        return T.default.os.android && (o = 3),
          r.length ? (t = n[r],
            21 !== t && 24 !== t || (t = 5),
            22 === t && (t = 9),
            20 === t && 3 === o && (t = 14),
      ...
      function f(e) {
        ...
        switch (o) {
          case "detail":
            ...
            break;
          case "comment":
            a = n + "detail?groupid=" + i + "&showcomment=1&gd_label=" + r + "&gd_ext_json=" + (0,
                x.default)({
                enter_comment: r
              }),
              n = t(a, e);
            break;
          case "mediaProfile":
            a = n + "media_account?media_id=" + i + "&gd_ext_json=" + (0,
              x.default)({
              event: "pgc_profile",
              label: r
            });
            break;
          case "home":
            a = n + "home/news?growth_from=" + r + "&gd_ext_json=" + (0,
              x.default)({
              event: "home",
              label: r
            })
      ...
      function m() {
        function e(e) {
          ...
          (window.scrollY || window.pageYOffset || document.body.scrollTop || document.documentElement.scrollTop) >= o - window.innerHeight - r && t(window).trigger("scrollBottom", e.type),
            "scroll" === e.type && (n && clearTimeout(n),
      ...
      function _(e) {
        ...
        return g("http://[::1]:28192?" + r).then(function (e) {}, function (e) {
          return g(o)
        })
      }
      ...
      var S = function () {
          var e = y(),
            t = T.default.browser.weixin && T.default.os.android,
            n = "";
        ...
        M = {
          ...
          testAD: v,
          getTTWebID: o,
          androidLocalServer: _,
          bottomBannerSDKShortLink: S
        };
      e.exports = M
    }).call(t, n("gXQ3"))
  },
  ...
  hAp8: function (e, t, n) {
    ...
    var o = n("iltz"),
      ...
      w = n("aZsa");
    n("QLF1");
    var b = "ttvideo" === y.default.request("activity") || "m.ixigua.com" === location.host,
      k = function (e) {
        function t() {
          return (0,
              s.default)(this, t),
    ...
    k.propTypes = {
        showRefreshTip: g.default.bool,
        fetchNumber: g.default.number
      },
      e.exports = k
  },
  hJ6a: function (e, t, n) {
  ...
  hK0m: function (e, t, n) {
    ...
    (function (t) {
      ...
      function o(e) {
        ...
        (0,
          a.default)(n, e || {}),
        "m.toutiaoribao.cn" === location.host && (n.downloadLink = "http://d.toutiaoribao.cn/NtNA/",
          n.app = "toutiaoribao",
          "toutiaoribao_newssocial" === u.default.request("app") && (n.downloadLink = "https://d.toutiaoribao.cn/LUQB/"));
        ...
        window.group_id && t.extend(!0, n, {
          ...
          n.nativeLink = n.nativeLink || f.getNativeLink(n),
          d.os.ios ? d.browser.weixin ? (c.jumpToNativeapp(n),
            setTimeout(function () {
              l.gotoAppDownload(n)
            }, 1e3)) : (l.gotoAppDownload(n),
            setTimeout(function () {
              c.jumpToNativeapp(n)
            }, 1e3)) : (c.jumpToNativeapp(n),
            l.gotoAppDownload(n))
      }
      var i = n("dU2U"),
        a = r(i),
  ...
  kZEW: function (e, t, n) {
    ...
    function o() {
      k.forEach(function (e) {
          !e.visible && a(e) && (x.push(e),
            e.visible = !0,
            e.props.onFirstInView())
        }),
        i()
    }
      ...
      E = function (e) {
        ...
        return (0,
          ...
          (0,
            ...
            key: "componentDidMount",
            value: function () {
              0 === k.length && window.addEventListener("scroll", o),
                k.push(this),
                o()
            }
          }, {
            ...
            value: function () {
              ...
              1 !== e && k.splice(e, 1),
                0 === k.length && window.removeEventListener("scroll", o)
            }
          }, {
            key: "render",
            value: function () {
    ...
    E.propTypes = {
        children: b.default.oneOfType([b.default.arrayOf(b.default.node), b.default.node])
      },
      e.exports = E
  },
  lH70: function (e, t, n) {
      ...
      (o.nunjucksPrecompiled = o.nunjucksPrecompiled || {})["app/components/ListCardAD/template.nunjucks"] = function () {
        function e(e, t, n, r, o) {
          ...
          try {
            var a = null;
            if (i += '\n<i class="icon_ad">\n    <span data-show="show"\n        ad-log-extra="',
              i += r.suppressValue(r.contextOrFrameLookup(t, n, "log_extra"), e.opts.autoescape),
              i += '"\n        data-track="',
              i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_track_url"), e.opts.autoescape),
              i += '"\n        ad-id="',
              i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_id"), e.opts.autoescape),
              i += '"\n        ad-tag="embeded_ad"\n        ad-label="',
              i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_label"), e.opts.autoescape),
              i += '">\n    </span>\n</i>\n\n',
              ...
              if (i += '\n<div class="article_link clearfix creative_type"\n    ad-tag="{tag}}"\n    ad-url="',
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "source_url"), e.opts.autoescape),
                i += '"\n    ',
                r.contextOrFrameLookup(t, n, "is_download_ad") && (i += 'ad-load="true"'),
                i += '\n    ad-id="',
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_id"), e.opts.autoescape),
                i += '"\n    ad-log-extra="',
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "log_extra"), e.opts.autoescape),
                ...
                2 == r.contextOrFrameLookup(t, n, "image_mode") && (i += "image-margin-right"),
                i += '"\n        ',
                r.contextOrFrameLookup(t, n, "highlight") && (i += 'highlight="',
                  i += r.suppressValue(e.getFilter("dump").call(t, r.memberLookup(r.contextOrFrameLookup(t, n, "highlight"), "title")), e.opts.autoescape),
                  i += '"'),
                i += ">\n        ",
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "title"), e.opts.autoescape),
                i += "\n    </h3>\n\n    ",
              ...
              i += "\n\n    ",
                3 == r.contextOrFrameLookup(t, n, "image_mode") && (i += '\n    <div class="list_img_holder_large ',
                  r.contextOrFrameLookup(t, n, "ad_label") || (i += "list_img_holder_large_fix"),
                  i += '">\n        <img ',
                  r.contextOrFrameLookup(t, n, "ad_type") || (i += 'src="',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "image_url"), e.opts.autoescape),
                    i += '"'),
                  ...
                  r.contextOrFrameLookup(t, n, "source") && (i += '\n        <span class="source">',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "source"), e.opts.autoescape),
                    i += "</span>\n        "),
                  i += "\n\n        ",
                  r.contextOrFrameLookup(t, n, "is_download_ad") && (i += '\n        <span class="download" ad-url="',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "download_url"), e.opts.autoescape),
                    i += '">立即下载</span>\n        '),
                  i += "\n\n        ",
                  r.contextOrFrameLookup(t, n, "is_phone_ad") && (i += '\n        <span class="phone" ad-url="',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "phone_number"), e.opts.autoescape),
                    i += '">',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "button_text"), e.opts.autoescape),
                    i += "</span>\n        "),
                  i += "\n    </div>\n    "),
                i += '\n\n    <div class="item_info">\n        ',
                ...
                2 == !r.contextOrFrameLookup(t, n, "image_mode") && (i += '\n        <span class="time" title="',
                  i += r.suppressValue(r.contextOrFrameLookup(t, n, "datetime"), e.opts.autoescape),
                  i += '">',
                  i += r.suppressValue(r.contextOrFrameLookup(t, n, "timeago"), e.opts.autoescape),
                  i += "</span>\n        "),
                i += "\n    </div>\n\n    ",
              ...
              if (i += '\n<a href="',
                ...
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "action_label"), e.opts.autoescape),
                i += '"\n    data-tag="',
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "tag"), e.opts.autoescape),
                i += '">\n\n    ',
                r.contextOrFrameLookup(t, n, "middle_mode") && (i += '\n    <div class="desc">\n    '),
                i += '\n\n    <h3 class="dotdot line3 ',
                r.contextOrFrameLookup(t, n, "middle_mode") && (i += "image-margin-right"),
                i += '"\n        ',
                r.contextOrFrameLookup(t, n, "highlight") && (i += 'highlight="',
                  i += r.suppressValue(e.getFilter("jsonify").call(t, r.memberLookup(r.contextOrFrameLookup(t, n, "highlight"), "title")), e.opts.autoescape),
                  i += '"'),
                i += ">\n        ",
                i += r.suppressValue(r.contextOrFrameLookup(t, n, "title"), e.opts.autoescape),
                i += "\n    </h3>\n\n    ",
              ...
              i += "\n\n    ",
                (r.contextOrFrameLookup(t, n, "large_mode") || "taobao" == r.contextOrFrameLookup(t, n, "ad_type")) && (i += '\n    <div class="list_img_holder_large ',
                  ...
                  i += '">\n        <img ',
                  r.contextOrFrameLookup(t, n, "ad_type") || (i += 'src="',
                    i += r.suppressValue(r.contextOrFrameLookup(t, n, "large_image_url"), e.opts.autoescape),
                    i += '"'),
                  i += "\n            onerror='errorimg.call(this)'\n            onload='loadimg.call(this)' />\n        ",
                  r.contextOrFrameLookup(t, n, "has_video") && (i += '\n        <span class="video-btn"></span>\n        '),
                  i += "\n    </div>\n    "),
                ...
                r.contextOrFrameLookup(t, n, "subject_label") && (i += '\n        <span class="subject_label">',
                  i += r.suppressValue(r.contextOrFrameLookup(t, n, "subject_label"), e.opts.autoescape),
                  i += "</span>\n        "),
                i += "\n\n        ",
                r.contextOrFrameLookup(t, n, "ad_label") && (i += '\n        <span class="gg_label space">',
                  i += r.suppressValue(r.contextOrFrameLookup(t, n, "ad_label"), e.opts.autoescape),
                ...
                r.contextOrFrameLookup(t, n, "subject_label") || (i += '\n        <span class="src space',
                  "百度经验" == r.contextOrFrameLookup(t, n, "source") && (i += "recommend_label"),
                  i += '">',
                  i += r.suppressValue(r.contextOrFrameLookup(t, n, "source"), e.opts.autoescape),
                  i += "</span>"),
                i += '\n\n        <span class="cmt space">评论 ',
        ...
        (0,
          ...
          value: function () {
            ...
            return m.default.createElement("div", {
              ...
              className: "banner"
            }), m.default.createElement("p", null, "已加载好您感兴趣的头条"), m.default.createElement("div", {
  ...
  mr6U: function (e, t, n) {
    ...
    function s(e, t) {
      return k.length ? k.forEach(function (n) {
      ...
      function (e) {
        ...
        return a(t, e),
          ...
          t.prototype.transition = function (e, t, n) {
            ...
            n ? (a = setTimeout(l, n),
              this.transitionTimeouts.push(a)) : m.transitionEnd && (u = s(r, l))
          },
          ...
          t.prototype.render = function () {
            ...
            return delete e.name,
              ...
              delete e.children,
              g.default.cloneElement(g.default.Children.only(this.props.children), e)
          },
          t
      }(g.default.Component));
  ...
  oFNu: function (e, t, n) {
    ...
    (function (t) {
      ...
      function i(e) {
        ...
        if (n[r])
          return !1;
        if (!K.default.localStorageEnabled)
          return !1;
      ...
      var oe = function (e) {
        function n(e) {
          (0,
            p.default)(this, n);
          var t = (0,
            g.default)(this, (n.__proto__ || (0,
            f.default)(n)).call(this, e));
          return (0,
              V.default)(),
            ...
            t.state = {
              ...
              fetchNumber: 0,
              showRefreshTip: !1,
              fetchTips: G.NETWORKTIPS.LOADING,
              doADTest: {
                position: 0,
                doADTest: !1
              },
        ...
        return (0,
          ...
          (0,
            ...
            value: function () {
              var e = this,
                t = K.default.localStorageEnabled() ? localStorage.menuDefaults : "";
              return (t ? t.split(",") : (0,
                l.default)(this.channelCategoryList).slice(0, 12)).reduce(function (t, n) {
                if (e.channelCategoryList[n])
                  return t[n] = e.channelCategoryList[n],
                    t
              }, {})
            }
          }, {
            ...
            value: function () {
              ...
              return -1 === (0,
                  l.default)(this.channelCategoryList).indexOf(e) && (e = this.defaultCategory),
                -1 === (0,
                  l.default)(this.getTabs()).indexOf(e) && (e = this.defaultCategory),
            ...
            value: function (e, t) {
              var n = function () {
                  var e = [],
                    t = K.default.request();
                  for (var n in t)
                    "channel" !== n && e.push([n, encodeURIComponent(t[n])].join("="));
                  return e.join("&") || ""
                }(),
                r = (n ? n + "&" : "") + [t, t].join("#");
            ...
            value: function (e, n) {
              ...
              var i = this.state.listData,
                ...
                u = 0,
                l = 0;
              s.length && (u = s[s.length - 1].behot_time,
                l = s[0].behot_time);
              var c = {
                tag: e,
                ac: "wap",
              ...
              H.default.get("/list/?" + X.default.stringify(c)).end(function (n, u) {
                if (r.fetchLock = !1,
                  n)
                  return r.setState({
                      fetchTips: G.NETWORKTIPS.RETRY
                    }),
                    null;
                var l = JSON.parse(u.text);
                if (0 === l.return_count)
                  return r.setState({
                      fetchTips: G.NETWORKTIPS.RECOMMENDEMPTY
                    }),
                    null;
                var c = l.data;
                r.state.doADTest.doADTest && c.splice(r.state.doADTest.position - 1, 0, {
                  ...
                  "append" === a ? (s = [].concat(s, c),
                    window.refreshCount ? window.refreshCount = window.refreshCount + 1 : window.refreshCount = 1) : "prepend" === a && (s = s.filter(function (e) {
                      return -1 === c.map(function (e) {
                        return e.group_id
                      }).indexOf(e.group_id)
                    }),
                    s = [].concat(c, s)),
            ...
            value: function (e, t) {
              ...
              this.shouldFetchListData(n, this.state.listData) && this.fetchListData(n, t),
                ne.default.scrollChangeDisable = !0,
            ...
            key: "handleMoreClick",
            value: function () {
              window.location = K.default.appendQuery("/channels/", "need_open_window=1"),
            ...
            key: "handleScroll",
            value: function (e) {
              "append" === e && ee.default.checkReferrer && window.refreshCount >= 20 || this.getListData({
                direction: e
              })
            }
          }, {
            ...
            value: function () {
              ...
              var d = this.props.Header || C.default,
                p = this.props.TopMenu || M.default,
                h = this.props.MainContent || j.default,
                m = this.props.DownloadBanner || R.default;
              return x.default.createElement("div", {
                id: "indexContainer",
                className: "indexContainer " + (t ? "hideHeader " : "withHeader ") + (this.props.className || "")
              }, x.default.createElement(d, (0,
                s.default)({
                GTMValue: f,
                rotateRefreshBtn: c,
              ...
              }, this.props)), this.state.showAuditInfo ? x.default.createElement(B.default, null) : x.default.createElement("div", null, x.default.createElement(p, {
                GTMValue: f,
                tabList: r,
              ...
              }), a ? x.default.createElement(q.default, {
                fetchNumber: a,
                showRefreshTip: u
              }) : null, x.default.createElement(N.default, {
                handleScroll: function (t) {
                  return e.handleScroll(t)
                }
              }, x.default.createElement(h, {
                GTMValue: f,
                listData: i[o] || [],
                tips: l,
                currentChannel: o,
              ...
              }), !this.props.hideDownloadBanner && x.default.createElement(m, null)))
            }
          }]),
          n
      }(k.Component);
  ...
  uGEv: function (e, t, n) {
    ...
    var s = Object.assign || function (e) {
      ...
      m = r(h),
      v = n("MKUs"),
      g = (v.nameShape.isRequired,
        f.default.bool,
        f.default.bool,
        f.default.bool,
        (0,
          v.transitionTimeout)("Appear"),
        (0,
          v.transitionTimeout)("Enter"),
        (0,
          v.transitionTimeout)("Leave"), {
          transitionAppear: !1,
          transitionEnter: !0,
          transitionLeave: !0
        }),
    ...
    _.displayName = "CSSTransitionGroup",
      _.propTypes = {},
      _.defaultProps = g,
      t.default = _,
      e.exports = t.default
          ...
          (0,
            ...
            value: function (e) {
              ...
              if (this.state.scrollY <= 0) {
                t - this.state.touchStartY > 100 && (e.preventDefault(),
  ...
  wtgB: function (e, t, n) {
    (function (t, n) {
      ...
      ! function (t, n) {
        ...
        function g(e, t) {
          t._state === $ ? b(e, t._result) : t._state === Z ? k(e, t._result) : x(t, void 0, function (t) {
            return y(e, t)
          }, function (t) {
            return k(e, t)
          })
        ...
        function _(e, t, n) {
          t.constructor === e.constructor && n === l && t.constructor.resolve === c ? g(e, t) : n === ee ? (k(e, ee.error),
            ee.error = null) : void 0 === n ? b(e, t) : r(n) ? v(e, t, n) : b(e, t)
        }

        function y(t, n) {
          t === n ? k(t, d()) : e(n) ? _(t, n, h(n)) : b(t, n)
        }
        ...
        function b(e, t) {
          e._state === Q && (e._result = t,
            e._state = $,
            0 !== e._subscribers.length && z(E, e))
        }

        function k(e, t) {
          e._state === Q && (e._state = Z,
            e._result = t,
            z(w, e))
        }
        ...
        function O(e, t, n, o) {
          ...
          if (i) {
            ...
            a = o,
            u = !0;
          t._state !== Q || (i && u ? y(t, a) : l ? k(t, s) : e === $ ? b(t, a) : e === Z && k(t, a))
        }
              ...
              this._instanceConstructor = e,
                ...
                F(t) ? (this.length = t.length,
                  ...
                  0 === this.length ? b(this.promise, this._result) : (this.length = this.length || 0,
                    this._enumerate(t),
                    0 === this._remaining && b(this.promise, this._result))) : k(this.promise, A())
            }
  ...
  xDfE: function (e, t, n) {
    ...
    var k = function (e) {
      ...
      return (0,
        ...
        (0,
          ...
          key: "onMenuClick",
          value: function (e) {
            if ("news_car" === e.currentTarget.dataset.channel)
              return void(location.href = "https://m.dcdapp.com/?zt=tt_m_car");
            if ("news_house" === e.currentTarget.dataset.channel)
              return void(location.href = "https://m.xflapp.com/?from=mw_official");
          ...
          value: function () {
            ...
            }, r ? null : g.default.createElement("div", {
    ...
    k.propTypes = {
        defaultChannel: y.default.string,
        tabList: y.default.object,
        GTMValue: y.default.object,
        onMenuClick: y.default.func,
        onMoreClick: y.default.func,
        hideTopMenuMore: y.default.bool,
  ...
  xPW0: function (e, t, n) {
    "use strict";
    t.decode = t.parse = n("Ah8g"),
      t.encode = t.stringify = n("pnWs")
  },
  xsko: function (e, t) {},
  yRjA: function (e, t, n) {
    "use strict";
    (function (t) {
      ...
      function l() {
        var e = 17;
        i() && (e = 16),
          x.default.browser.weixin && (e = 41);
        var t = "UA-28423340-" + e;
        navigator.userAgent.indexOf("ArticleStreamSdk") > -1 || "open" === T.default.request("utm_campaign") ? t = "UA-28423340-11" : "m.ixigua.com" === location.host && (t = "UA-28423340-51"),
      ...
      function f() {
        ...
        var t = T.default.request("wxshare_banner");
        !isNaN(t) && t > 0 && window.ga("set", "dimension10", t);
        var n = T.default.request("readmore");
        !isNaN(n) && n > 0 && window.ga("set", "dimension2", n);
        var r = T.default.hash("channel") || T.default.request("channel") || "__all__";
        r && window.ga("set", "dimension4", r);
        var o = Number(window.hasVideo);
        if (0 !== o && 1 !== o || window.ga("set", "dimension5", o),
          i()) {
          var a = T.default.request("app");
          a && window.ga("set", "dimension6", a);
          var s = T.default.request("utm_medium");
          s && window.ga("set", "dimension7", s);
          var u = T.default.request("isappinstalled");
          ...
          window.ga("set", "dimension6", T.default.getBrowserName()),
          window.ga("set", "dimension8", navigator.userAgent),
          window.ga("set", "dimension9", window.city || "");
        var l = location.pathname;
        l && -1 !== l.indexOf("/sem/") && T.default.request("atdl") && window.ga("set", "dimension5", T.default.request("atdl"))
      }
