<template>
  <div class="scroll-wrap" ref="scrollWrapper">
    ...
    >
      <list-item :list-data="scrollData" @loadimg="onLoadImg" />
      ...
      <!-- <template slot="pullup" slot-scope="props">
        <div v-if="props.pullUpLoad">
          <div v-show="props.isPullUpLoad" class="loading-more"><cube-loading></cube-loading></div>
        </div>
      </template> -->
    </cube-scroll>
  </div>
